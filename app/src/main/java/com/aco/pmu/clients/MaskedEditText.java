...
public class MaskedEditText extends AppCompatEditText implements View.OnTouchListener, View.OnFocusChangeListener {
    ...
    private void initByAttributes(Context context, AttributeSet attrs) {
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, com.thrd.maskededittext.R.styleable.MaskedEditText, 0, 0);

        if (TextUtils.isEmpty(mask) && TextUtils.isEmpty(notMaskedSymbol)) {
            notMaskedSymbol = a.getString(com.thrd.maskededittext.R.styleable.MaskedEditText_notMaskedSymbol);
            mask = a.getString(com.thrd.maskededittext.R.styleable.MaskedEditText_mask);

            int maskedIconRes = a.getResourceId(com.thrd.maskededittext.R.styleable.MaskedEditText_maskIcon, 0);
            ...
            if (maskedIconRes > 0) {
                ...
                if (drawableIcon != null) {
                    ...
                    int drawableIconColor = a.getColor(com.thrd.maskededittext.R.styleable.MaskedEditText_maskIconColor, getCurrentHintTextColor());
        ...
        if (!TextUtils.isEmpty(mask) && !TextUtils.isEmpty(notMaskedSymbol)) {
            deleteChar = a.getString(com.thrd.maskededittext.R.styleable.MaskedEditText_deleteChar);
            if (deleteChar == null) deleteChar = " ";

            replacementChar = a.getString(com.thrd.maskededittext.R.styleable.MaskedEditText_replacementChar);
            if (replacementChar == null) replacementChar = " ";

            String format = a.getString(com.thrd.maskededittext.R.styleable.MaskedEditText_format);
        ...
        int inputType = a.getInteger(com.thrd.maskededittext.R.styleable.MaskedEditText_android_inputType, -1);
